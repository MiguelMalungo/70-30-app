...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-otu7zt$^@#l8vaz&#!o=zb1l$=+*r%j&9b!#@+^7z38duaz4c-')
...
# Cache — use Redis in production, fallback to local memory for dev
...
# Channel Layers — use Redis when available, otherwise in-memory
if REDIS_URL:
    CHANNEL_LAYERS = {
        'default': {
...
VAPID_CLAIMS = {'sub': 'mailto:admin@7030.pt'}
